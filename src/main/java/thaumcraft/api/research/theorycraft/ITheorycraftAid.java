...
/**
 * Interface for objects that add bonus theorycraft cards when near a research table.
 * 
 * See AidBookshelf for an example implementation.
 * 
 * @author Azanor
 */
public interface ITheorycraftAid {
     ...
     * @return The trigger object (Block, Item, ItemStack, or Entity class)
     */
    Object getAidObject();
     ...
     * @return Array of TheorycraftCard classes to add
     */
